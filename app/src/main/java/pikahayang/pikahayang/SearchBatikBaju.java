...
public class SearchBatikBaju extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,
    ...
    private static final String TAG = SearchBatikBaju.class.getSimpleName();
    ...
    private void callData(){
        ...
        swipeSearch.setRefreshing(true);
            ...
            JsonArrayRequest jArr = new JsonArrayRequest(URL.data_baju, new Response.Listener<JSONArray>() {
                @Override
...
//                Toast.makeText(SearchBatik.this, error.getMessage(), Toast.LENGTH_LONG).show();
    ...
    public boolean onCreateOptionsMenu(android.view.Menu menu) {
        ...
        searchView.setQueryHint("Cari produk baju..");
    ...
    private void cariData(final String keyword){
        pDialog = new ProgressDialog(SearchBatikBaju.this);
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if (value == 1) {
                            ...
                            ChocoBar.builder().setActivity(SearchBatikBaju.this)
