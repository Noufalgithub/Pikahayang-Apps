...
public class SearchBatik extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,
    ...
    private static final String TAG = SearchBatik.class.getSimpleName();
    ...
    private void callData(){
        ...
        swipeSearch.setRefreshing(true);
            ...
            JsonArrayRequest jArr = new JsonArrayRequest(URL.data, new Response.Listener<JSONArray>() {
                @Override
...
//                Toast.makeText(SearchBatik.this, error.getMessage(), Toast.LENGTH_LONG).show();
    ...
    public boolean onCreateOptionsMenu(android.view.Menu menu) {
        ...
        searchView.setQueryHint("Cari nama batikmu..");
    ...
    private void cariData(final String keyword){
        pDialog = new ProgressDialog(SearchBatik.this);
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if (value == 1) {
                            ...
                            ChocoBar.builder().setActivity(SearchBatik.this)
